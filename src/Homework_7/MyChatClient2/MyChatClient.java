...
public class MyChatClient {
    ...
    private Homework_7.MyChatClient2.MyChatRxSocket rxSocket;
    private Homework_7.MyChatClient2.MyChatTxSocket txSocket;
    ...
    public void startClient() throws IOException {
        ...
        rxSocket = new Homework_7.MyChatClient2.MyChatRxSocket(clientSocket, "MyChat_RX_Socket");
        rxSocket.start();

        txSocket = new Homework_7.MyChatClient2.MyChatTxSocket(clientSocket, "MyChat_TX_Socket");
        txSocket.start();
